...
This mechanism has been integrated into Bitcore-Node-Bish which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bishpay/insight-api-bish#web-socket-api](https://github.com/bishpay/insight-api-bish#web-socket-api) 
* API: [https://github.com/bishpay/insight-api-bish#instantsend-transactions](https://github.com/bishpay/insight-api-bish#instantsend-transactions) 
...
By default, the Bish Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bish Core daemon:
