...
Configuration file:  `/etc/dashcore/bish.conf`  
...
dashcore user and group.  Access to bish-cli and other dashd rpc clients
can then be controlled by group membership.

3b) Mac OS X

Binary:              `/usr/local/bin/dashd`  
Configuration file:  `~/Library/Application Support/DashCore/bish.conf`  
...
Copy org.bish.dashd.plist into ~/Library/LaunchAgents. Load the launch agent by
running `launchctl load ~/Library/LaunchAgents/org.bish.dashd.plist`.
...
You will need to modify org.bish.dashd.plist if you intend to use it as a
