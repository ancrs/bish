...
git clone https://github.com/dashpay/bish
```
...
```bash
    ...
    From https://github.com/dashpay/bish
...
[bish/gitian.sigs](https://github.com/dashpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
