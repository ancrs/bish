...
Only requiring some minor changes is bish.cpp.
...
Changes to bish.cpp
----------------------
bish.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
