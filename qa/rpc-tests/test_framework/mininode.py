# mininode.py - Bish P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a bish node
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest", services=1):
        ...
        print 'MiniNode: Connecting to Bish Node IP # ' + dstaddr + ':' \
            + str(dstport)
