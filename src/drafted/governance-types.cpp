...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BishNetwork") type = BishNetwork;
    if(strType == "BishNetworkVariable") type = BishNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BishNetwork) s = "BishNetwork";
    if(type == BishNetworkVariable) s = "BishNetworkVariable";
