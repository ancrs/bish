 ...
 *
 *   // network
 *   CBishNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bish.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBishNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: BishNetwork
// //   -- signature requirements : Key1(User)
// class CBishNetworkVariable : public CGovernanceObject
// {
// private:
