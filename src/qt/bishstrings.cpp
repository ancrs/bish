...
QT_TRANSLATE_NOOP("bish-core", ""
"Disable all Bish specific functionality (Masternodes, PrivateSend, "
...
"is wrong Bish Core will not work properly."),
QT_TRANSLATE_NOOP("bish-core", ""
...
"transaction that are not equal 1000 BISH."),
QT_TRANSLATE_NOOP("bish-core", ""
...
QT_TRANSLATE_NOOP("bish-core", "%s - %d confirmations"),
QT_TRANSLATE_NOOP("bish-core", "(%d could be used only on mainnet)"),
QT_TRANSLATE_NOOP("bish-core", "(default: %s)"),
QT_TRANSLATE_NOOP("bish-core", "(default: %u)"),
QT_TRANSLATE_NOOP("bish-core", "(must be %d for mainnet)"),
QT_TRANSLATE_NOOP("bish-core", "-maxmempool must be at least %d MB"),
...
QT_TRANSLATE_NOOP("bish-core", "Activating best chain..."),
...
QT_TRANSLATE_NOOP("bish-core", "Append comment to the user agent string"),
QT_TRANSLATE_NOOP("bish-core", "Attempt to recover private keys from a corrupt wallet.dat on startup"),
QT_TRANSLATE_NOOP("bish-core", "Automatic backups disabled"),
QT_TRANSLATE_NOOP("bish-core", "Automatically create Tor hidden service (default: %d)"),
...
QT_TRANSLATE_NOOP("bish-core", "ERROR! Failed to create automatic backup"),
QT_TRANSLATE_NOOP("bish-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("bish-core", "Enable publish hash transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("bish-core", "Enable publish hash transaction in <address>"),
QT_TRANSLATE_NOOP("bish-core", "Enable publish raw block in <address>"),
QT_TRANSLATE_NOOP("bish-core", "Enable publish raw transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("bish-core", "Enable publish raw transaction in <address>"),
QT_TRANSLATE_NOOP("bish-core", "Enable the client to act as a masternode (0-1, default: %u)"),
QT_TRANSLATE_NOOP("bish-core", "Enable transaction replacement in the memory pool (default: %u)"),
...
QT_TRANSLATE_NOOP("bish-core", "Error: A fatal internal error occurred, see debug.log for details"),
QT_TRANSLATE_NOOP("bish-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("bish-core", "Failed to create backup %s!"),
QT_TRANSLATE_NOOP("bish-core", "Failed to create backup, error: %s"),
QT_TRANSLATE_NOOP("bish-core", "Failed to delete backup, error: %s"),
QT_TRANSLATE_NOOP("bish-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("bish-core", "Failed to parse host:port string"),
QT_TRANSLATE_NOOP("bish-core", "Fee (in %s/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("bish-core", "Imports blocks from external blk000??.dat file on startup"),
...
QT_TRANSLATE_NOOP("bish-core", "Invalid amount for -fallbackfee=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("bish-core", "Keep the transaction memory pool below <n> megabytes (default: %u)"),
...
QT_TRANSLATE_NOOP("bish-core", "Loading fullfiled requests cache..."),
QT_TRANSLATE_NOOP("bish-core", "Loading governance cache..."),
...
QT_TRANSLATE_NOOP("bish-core", "Location of the auth cookie (default: data dir)"),
...
QT_TRANSLATE_NOOP("bish-core", "Make the wallet broadcast transactions"),
QT_TRANSLATE_NOOP("bish-core", "Masternode cache is empty, skipping payments and governance cache..."),
...
QT_TRANSLATE_NOOP("bish-core", "Minimum bytes per sigop in transactions we relay and mine (default: %u)"),
...
QT_TRANSLATE_NOOP("bish-core", "No errors detected."),
...
QT_TRANSLATE_NOOP("bish-core", "Not enough funds to anonymize."),
QT_TRANSLATE_NOOP("bish-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("bish-core", "Number of automatic wallet backups (default: %u)"),
...
QT_TRANSLATE_NOOP("bish-core", "Port: %d"),
QT_TRANSLATE_NOOP("bish-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("bish-core", "Print version and exit"),
...
QT_TRANSLATE_NOOP("bish-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("bish-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("bish-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("bish-core", "RPC server options:"),
QT_TRANSLATE_NOOP("bish-core", "Rebuild block chain index from current blk000??.dat files on startup"),
QT_TRANSLATE_NOOP("bish-core", "Receive and display P2P network alerts (default: %u)"),
QT_TRANSLATE_NOOP("bish-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
...
QT_TRANSLATE_NOOP("bish-core", "Rescan the block chain for missing wallet transactions on startup"),
QT_TRANSLATE_NOOP("bish-core", "Rescanning..."),
QT_TRANSLATE_NOOP("bish-core", "Run in the background as a daemon and accept commands"),
QT_TRANSLATE_NOOP("bish-core", "Send trace/debug info to console instead of debug.log file"),
...
QT_TRANSLATE_NOOP("bish-core", "Synchronizing governance objects..."),
QT_TRANSLATE_NOOP("bish-core", "Synchronizing masternode payments..."),
QT_TRANSLATE_NOOP("bish-core", "Synchronizing masternodes..."),
QT_TRANSLATE_NOOP("bish-core", "Synchronizing sporks..."),
QT_TRANSLATE_NOOP("bish-core", "The transaction amount is too small to pay the fee"),
...
QT_TRANSLATE_NOOP("bish-core", "Too many %f denominations, removing."),
QT_TRANSLATE_NOOP("bish-core", "Tor control port password (default: empty)"),
QT_TRANSLATE_NOOP("bish-core", "Tor control port to use if onion listening enabled (default: %s)"),
...
QT_TRANSLATE_NOOP("bish-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("bish-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("bish-core", "Unknown response."),
QT_TRANSLATE_NOOP("bish-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("bish-core", "Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("bish-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("bish-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("bish-core", "Upgrade wallet to latest format on startup"),
...
QT_TRANSLATE_NOOP("bish-core", "User Agent comment (%s) contains unsafe characters."),
...
QT_TRANSLATE_NOOP("bish-core", "Very low number of keys left: %d"),
...
QT_TRANSLATE_NOOP("bish-core", "Warning: unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("bish-core", "Wasn't able to create wallet backup folder %s!"),
QT_TRANSLATE_NOOP("bish-core", "Whether to operate in a blocks only mode (default: %u)"),
...
QT_TRANSLATE_NOOP("bish-core", "ZeroMQ notification options:"),
QT_TRANSLATE_NOOP("bish-core", "no mixing available."),
QT_TRANSLATE_NOOP("bish-core", "see debug.log for details."),
