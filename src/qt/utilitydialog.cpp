    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bish Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bish Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bish-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Bish in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BISH, 0.1 BISH, 1 BISH and 10 BISH -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bishpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://bishpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bish Core is shutting down...") + "<br /><br />" +
