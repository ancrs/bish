    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BISH-light"), QVariant("light"));
    ui->theme->addItem(QString("BISH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BISH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BISH-traditional"), QVariant("trad"));
