    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bish Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bish address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bish: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bish Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bish Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bish Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bish addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bish addresses"));
    ...
    openAction->setStatusTip(tr("Open a bish: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bish Core help message to get a list with possible Bish Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bish Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bish network", "", count));
}
...
{
    QString strTitle = tr("Bish Core"); // default title
