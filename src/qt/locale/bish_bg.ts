...
for example: alertnotify=echo %%s | mail -s "Bish Alert" admin@foo.com
        ...
        <translation>За използване на bishd, или the -server опция към bish-qt, трябва да зададете rpcpassword в конфигурационния файл: %s Препоръчително е да използвате следната произволна парола: rpcuser=bishrpc rpcpassword=%s (не е нужно да запомняте тази парола) Потребителя и паролата НЕ ТРЯБВА да са еднакви. Ако файла не съществува , създайте го с права за само за четене. Препоръчително е да създадете сигнал за уведомяване за да бъдете осведомени при проблем; Пример: alertnotify=echo %%s | mail -s "Bish Alert" admin@foo.com 
</translation>
    </message>
    <message>
